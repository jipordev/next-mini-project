...
function ProductCard({ name, price, image, desc, quantity, category }: ProductType) {
    return (
        <div className={`${styles.productCard} max-w-sm bg-[#ffffff] shadow-sm rounded-md flex flex-col justify-between`}>
