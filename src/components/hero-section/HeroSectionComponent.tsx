...
export default function HeroSectionComponent() {
  return (
        <section className="container-sm mx-5 md:mx-[100px] grid sm:grid-cols-1 md:grid-cols-2 gap-10 mt-12">
          <div className="flex flex-col justify-evenly m-auto">
            <h3 className='text-xl sm:text-xl md:text-2xl font-bold'>Please Buy</h3>
            ...
            <button className='rounded-xl mx-auto sm:ml-44 md:ml-56 font-semibold  my-5 px-6 py-2 border-[1px] w-max border-[#ff8b00] hover:bg-[#ff8b00] hover:text-white'>Get More</button>
          </div>
